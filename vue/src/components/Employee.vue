    ...
    <div style="width: 100%;height: 100%">
        <div style="width: 100%;height: 100%;position: relative">
            ...
            <el-table :data="tableData" size="mini"  border style="position: absolute;right: 10%;top: 12%;width: 100%">
                ...
                <el-table-column prop="address" label="常居地址" />
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            save() {
                if (this.editType) {
                    request.put("/api/employee",this.form).then(res => {
                        if (res.code === '0'){
                    ...
                    request.post("/api/employee",this.form).then(res => {
                        console.log(res);
                        if (res.code === '0'){
                            this.dialogVisible = false;
                            this.load();
            ...
            deleteRow(val) {
                request.delete("/api/employee/" + val ).then(res => {
                    if (res.code === '0'){
                        this.load();
                        this.$message({
                            type: "success",
